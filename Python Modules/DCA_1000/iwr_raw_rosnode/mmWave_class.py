...
class mmWave_Sensor():
    ...
    def __init__(self,
                iwr_cfg_dict,
                iwr_cmd_tty='/dev/ttyACM0',
                iwr_data_tty='/dev/ttyACM1'):
        ...
        self.q = queue.Queue()
        frame_len = 2 * iwr_cfg_dict['profiles'][0]['adcSamples'] * iwr_cfg_dict['numLanes'] * iwr_cfg_dict['numChirps']
        ...
        #TODO:Uncomment the next line out eventually
